...
def fit(args):
    ...
    if bboxes.ndim == 3 and bboxes.shape[1] == 1 and bboxes.shape[2] == 4:
...
if __name__ == '__main__':
    ...
    #python fit_single_img.py --img_path /root/gihoon/Audio2GeRF/StyleNeRF_Ray/out_0601_debug_NN_seed6_m03_front_neutral_m03_001_norm/output_from_w.png --res_folder results 

    #python fit_single_img.py --img_path /data2/MEAD/ffhq_aligned/m03_front_neutral/m03_001/frames/0000.png --res_folder results 

    #python fit_single_img.py --img_path /data2/RAVDESS/ffhq_aligned/speech/Actor_01/01-01-03-01-01-02-01/frames/0000.png --res_folder results 
