...
def generate_images(
    ...
    if not os.path.isfile(f"{outdir}/output_NeRFFaceSpeech.mp4"):
        ...
        segNet.load_state_dict(torch.load("/root/autodl-tmp/NeRFFaceSpeech_Code/pretrained_networks/seg.pth"))
        ...
        with torch.no_grad():
            ...
            PATH = "/root/autodl-tmp/NeRFFaceSpeech_Code/pretrained_networks/LipaintNet.pt"
